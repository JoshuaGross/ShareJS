...
(function() {
  ...
  Doc = function(connection, name, version, type, snapshot) {
    ...
    this.flush = function() {
      if (inflightOp === null && pendingOp !== null) {
        ...
        return connection.send({
          ...
          var callback, oldInflightOp, undo, _i, _j, _len, _len1, _ref;
          ...
          if (error) {
            ...
            _this.version++;
            for (_j = 0, _len1 = inflightCallbacks.length; _j < _len1; _j++) {
    ...
    this._onOpReceived = function(msg) {
      ...
      if (pendingOp !== null) {
        _ref1 = xf(pendingOp, docOp), pendingOp = _ref1[0], docOp = _ref1[1];
      }
      this.version++;
